...
import { LogoMark } from "@/components/LogoMarks";
...
const Marquee: FC<MarqueeProps> = ({ slice }) => {
  const MarqueeContent = () => (
    <div className="flex items-center bg-gray-200 py-10 whitespace-nowrap">
      {slice.primary.phrashes.map((item, i) => (
        <Fragment key={i}>
          <div className="font-black-slanted px-14 text-[180px] leading-none text-gray-400/80 uppercase [text-box:trim-both_cap_alphabetic] md:text-[260px]">
            {item.text}
          </div>
